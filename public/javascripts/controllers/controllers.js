app.controller("eveController", ["$scope", "eveService", function($scope, eveService){
  ...
  eveService.grabBuy($scope.view.regionId, 8529).then(function(data){
